...
import '../../styles/waimai/goods.scss'
...
export default class Goods extends Component {
  ...
  render() {
    const goodsData = [
      { id: 1, title: '宫保鸡丁', description: '宫保鸡丁，是一道闻名中外的特色传统名菜。鲁菜、川菜、贵州菜中都有收录，原料、做法有差别。', discount: '8', price: '98', spec: true },
      { id: 2, title: '宫保鸡丁', description: '宫保鸡丁，是一道闻名中外的特色传统名菜。鲁菜、川菜、贵州菜中都有收录，原料、做法有差别。', discount: '4', price: '98' },
      { id: 3, title: '宫保鸡丁', description: '宫保鸡丁，是一道闻名中外的特色传统名菜。鲁菜、川菜、贵州菜中都有收录，原料、做法有差别。', discount: '6', price: '98', spec: true },
      { id: 4, title: '宫保鸡丁', description: '宫保鸡丁，是一道闻名中外的特色传统名菜。鲁菜、川菜、贵州菜中都有收录，原料、做法有差别。', discount: '8', price: '98', spec: true },
      { id: 5, title: '宫保鸡丁', description: '宫保鸡丁，是一道闻名中外的特色传统名菜。鲁菜、川菜、贵州菜中都有收录，原料、做法有差别。', discount: '8', price: '98' },
    ]
    const { cartNum, allPrice } = this.state
    return (
      <div className='goods'>
