...
const CouponItem = ({ couponData }) => {
  ...
  return (
    <li className='coupon-item' onClick={ () => Mask(<SlidePage target='coupon-slide' showClose={ false }><UsePromotion { ...{ price } } /></SlidePage>) }>
...
const UsePromotion = ({ price }) => {
  return (
    <div className='use-promotion'>
      ...
      <p><Icon type={ require('../../img/svg/close.svg') } size='md' /></p>
    </div>
  )
}
