...
const Order = ({ service, carouselDatas, featureDatas, commentsInfo, commentList, handleChangeSort, currentSortIndex = 0 }) => {
  return (
    <div className='business'>
      <div className='banner'>
        <img className='left' src={ require('../img/business_log1.png') } alt='business' />
        <div className='right'>
